...
void I2C::begin()
{
  ...
  #else
    // activate internal pull-ups for twi
    // as per note from attiny24a manual pg??
    sbi(PORTD, 0);
    sbi(PORTD, 1);
  #endif
...
void I2C::lockUp()
{
  USICR = 0; //releases SDA and SCL lines to high impedance
  USICR = _BV(TWEN) | _BV(TWEA); //reinitialize TWI 
}
